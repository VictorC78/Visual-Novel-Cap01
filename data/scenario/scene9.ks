...
[glink  color="ts14"  storage="scene9.ks"  size="20"  text="Foi&nbsp;bem&nbsp;legal"  x="158"  y="278"  width="300"  height=""  _clickable_img=""  target="*r1"  ]
[glink  color="ts14"  storage="scene9.ks"  size="20"  text="Podia&nbsp;ter&nbsp;sido&nbsp;melhor"  x="158"  y="338"  width="300"  height=""  _clickable_img=""  target="*r2"  ]
[glink  color="ts14"  storage="scene9.ks"  size="20"  text="Muito&nbsp;chata"  x="158"  y="398"  width="300"  height=""  _clickable_img=""  target="*r3"  ]
[s  ]
*r1
...
[jump  storage="scene9.ks"  target="*notaBaixa"  cond="f.nota<3"  ]
[jump  storage="scene9.ks"  target="*notaAlta"  cond="f.nota>2"  ]
*r2
...
[jump  storage="scene9.ks"  target="*notaBaixa"  cond="f.nota<3"  ]
[jump  storage="scene9.ks"  target="*notaAlta"  cond="f.nota>1"  ]
*r3
...
[jump  storage="scene9.ks"  target="*notaBaixa"  cond="f.nota<2"  ]
[jump  storage="scene9.ks"  target="*notaAlta"  cond="f.nota>1"  ]
*notaBaixa
...
A gente pode ir lá em casa e estudamos lá.[p]
O que acha?[p]
[_tb_end_text]
