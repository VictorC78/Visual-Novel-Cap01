;メッセージレイヤの定義
		...
		[position width=1000 height=300 top=402 left=149 ]


		
			[position page=fore frame="caixaDeTexto.png" margint=45 marginl=10 marginr=20 marginb=10 vertical=false ]
		

		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=17 x=213 y=420 bold="bold" edge="undefined" shadow="undefined"]

		;キャラクターの表示モードに関する定義
		[chara_config ptext="chara_name_area" pos_mode=true time="600" memory="false" anim="true" effect="easeInQuad" pos_change_time="500" ]
		...
		[position layer="message1" width=1000 height=300 top=402 left=149 ]
