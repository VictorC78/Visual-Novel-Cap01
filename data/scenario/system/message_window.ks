;メッセージレイヤの定義
		...
		[position width=1240 height=237 top=417 left=20 ]
			...
			[position page=fore frame="Design_sem_nome.png" margint=45 marginl=10 marginr=20 marginb=10 vertical=false ]
		

		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=17 x=30 y=427 bold="bold" edge="undefined" shadow="undefined"]
