...
[bg  time="1000"  method="fadeInRight"  storage="hall_1.png"  ]
...
[tb_start_text mode=1 ]
#Cadú
Oi Luna, queria te pedir uma coisa...[p]
...
[bg  time="0"  method="crossfade"  storage="canto_hall.png"  ]
[tb_image_show  time="0"  storage="default/elemento1_015.png"  width="318"  height="460"  x="33"  y="385"  _clickable_img=""  name="img_50"  ]
[tb_image_show  time="0"  storage="default/elemento1_011.png"  width="170"  height="248"  x="104"  y="432"  _clickable_img=""  name="img_51"  ]
...
[tb_image_show  time="1000"  storage="default/balão_frase_001.png"  width="302"  height="437"  x="863"  y="-119"  _clickable_img=""  name="img_54"  ]
[wait  time="4000"  ]
[tb_image_hide  time="0"  ]
[chara_hide  name="Luna"  time="0"  wait="true"  pos_mode="true"  ]
[bg  time="000"  method="crossfade"  storage="cnto_hall_zoom.png"  ]
[tb_image_show  time="000"  storage="default/elemento1_015.png"  width="687"  height="996"  x="449"  y="-33"  _clickable_img=""  name="img_59"  ]
[tb_image_show  time="000"  storage="default/elemento1_011.png"  width="365"  height="530"  x="602"  y="67"  _clickable_img=""  name="img_60"  ]
[glink  color="ts14"  storage="scene2.ks"  size="20"  x="188"  y="267"  width="230"  height=""  text="Fazer&nbsp;carinho&nbsp;no&nbsp;gato"  _clickable_img=""  target="*carinho"  ]
[glink  color="ts14"  storage="scene2.ks"  size="20"  x="186"  y="329"  width="230"  height=""  text="Seguir&nbsp;com&nbsp;o&nbsp;tour"  _clickable_img=""  target="*seguir"  ]
[s  ]
...
[chara_show  name="Luna"  time="0"  wait="true"  storage="chara/2/timida.png"  width="684"  height="990"  left="495"  top="-91"  ]
[tb_show_message_window  ]
[tb_start_text mode=1 ]
#Luna
Ótima escolha[p]
