[_tb_system_call storage=system/_Cap1Cena1.ks]

[cm  ]
[bg  storage="de_cima.png"  time="1000"  method="vanishIn"  cross="true"  ]
[tb_show_message_window  ]
[tb_start_tyrano_code]
Bem-vindo ao Instituto Federal, [emb exp  = f.nome]! [p]
...
[bg  time="1000"  method="puffIn"  storage="entrance_to_a_J_e717a345-090b-4444-94d2-30b1f3d1b147.png"  cross="false"  ]
[chara_show  name="Luna"  time="1000"  wait="true"  storage="chara/2/normal_(4).png"  width="731"  height="1058"  left="278"  top="-79"  reflect="false"  ]
[tb_show_message_window  ]
...
[tb_start_text mode=1 ]
#Luna
São sim. Você vai adorar a maioria deles. Daqui a pouco te levo pra conhecer meus amigos.[p]
Vamos lá?[p]
...
[jump  storage="Cap1Cena2.ks"  target=""  ]
*p2
