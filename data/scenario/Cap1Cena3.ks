...
[tb_image_show  time="0"  storage="default/bolsa_001.png"  width="146"  height="212"  x="320"  y="266"  _clickable_img=""  name="img_22"  ]
[wait  time="1500"  ]
...
[jump  storage="Cap1Cena3.ks"  target="*prosseguir1"  ]
*ignorou

[tb_image_hide  time="0"  ]
[bg  time="0"  method="crossfade"  storage="Japanese_highsc_997d43f1-b720-4560-8e57-c5ed3ec9bdb0.png"  ]
[tb_show_message_window  ]
...
[jump  storage="Cap1Cena3.ks"  target="*prosseguir2"  ]
*guardarMochila2

[tb_image_show  time="0"  storage="default/bolsa_001.png"  width="138"  height="201"  x="325"  y="268"  _clickable_img=""  name="img_73"  ]
[wait  time="1500"  ]
[tb_image_hide  time="0"  ]
[bg  time="0"  method="crossfade"  storage="Japanese_highsc_997d43f1-b720-4560-8e57-c5ed3ec9bdb0.png"  ]
...
[chara_show  name="Luna"  time="1000"  wait="true"  storage="chara/2/normal_(4).png"  width="795"  height="1154"  left="274"  top="-147"  reflect="false"  ]
[tb_show_message_window  ]
...
[button  storage="Cap1Livro1.ks"  target=""  graphic="livro1.jpg"  width="329"  height="459"  x="133"  y="135"  _clickable_img=""  name="img_105"  ]
[button  storage="Cap1Livro2.ks"  target=""  graphic="livro2.jpg"  width="338"  height="457"  x="485"  y="135"  _clickable_img=""  name="img_106"  ]
[button  storage="Cap1Livro3.ks"  target=""  graphic="livro3.jpg"  width="305"  height="456"  x="845"  y="134"  _clickable_img=""  name="img_107"  ]
[s  ]
*prosseguir2

[tb_hide_message_window  ]
[chara_hide_all  time="0"  wait="true"  ]
[bg  time="1000"  method="puffIn"  storage="Japanese_school_f5ed886b-11d5-48a4-9e71-bf823bf30253.png"  cross="true"  ]
