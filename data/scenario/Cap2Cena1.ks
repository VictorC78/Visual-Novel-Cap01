...
#&f.nome
''Minha segunda semana no Instituto Federal. Apesar de já estar aqui há uma semana, ainda não conheci a maioria das pessoas da minha turma, nem explorei todos os cantos desse lugar. No entanto, sei que ainda tenho bastante tempo para fazer isso.''[p]
...
[resetfont  ]
[chara_show  name="Neto"  time="1000"  wait="true"  storage="chara/9/1_001.png"  width="746"  height="1083"  left="272"  top="6"  reflect="false"  ]
...
[tb_start_tyrano_code]
#??
Você é o [emb exp='f.nome'], não é? Bom dia. Eu sou o Neto, segurança do instituto. Tudo bem? A Luna me pediu para te dar um recado.[p]
[_tb_end_tyrano_code]

[chara_mod  name="Neto"  time="00"  cross="true"  storage="chara/9/1_001.png"  ]
[tb_start_tyrano_code]
#&f.nome
Sim, sou eu. Bom dia, Neto. Tudo bem. O que a Luna disse?[p]
[_tb_end_tyrano_code]

[chara_mod  name="Neto"  time="00"  cross="true"  storage="chara/9/1_007.png"  ]
[tb_start_text mode=1 ]
#Neto
Houve um pequeno acidente em um dos laboratórios. Pelo o que entendi, ocorreu um problema nos computadores.[p]
Então, a aula foi suspensa agora nos horários iniciais. A Luna pediu para te avisar que ela e os amigos estariam na quadra enquanto a aula não começa.[p]
[_tb_end_text]

[chara_mod  name="Neto"  time="00"  cross="true"  storage="chara/9/1_001.png"  ]
[glink  color="btn_16_lime"  storage="Cap2Cena1.ks"  size="20"  text="Obrigado&nbsp;por&nbsp;avisar."  x="817"  y="285"  width="300"  height=""  _clickable_img=""  target="*agradeceu"  ]
[glink  color="btn_16_lime"  storage="Cap2Cena1.ks"  size="20"  text="Irei&nbsp;para&nbsp;lá&nbsp;agora."  width="300"  x="817"  y="345"  height=""  _clickable_img=""  target="*naoAgradeceu"  ]
[s  ]
*agradeceu
...
[glink  color="btn_16_lime"  storage="Cap2Cena1.ks"  size="20"  text="Encher&nbsp;a&nbsp;garrafa"  x="101"  y="117"  width="200"  height=""  _clickable_img=""  target="*buscarAgua"  ]
[glink  color="btn_16_lime"  storage="Cap2Cena1.ks"  size="20"  text="Ir&nbsp;para&nbsp;a&nbsp;quadra"  x="104"  y="179"  width="200"  height=""  _clickable_img=""  target="*negarEncher"  ]
[s  ]
*buscarAgua

[tb_start_tyrano_code]
#&f.nome
Claro, adoraria ajudar. Me passe a garrafa que vou encher para o senhor.[p]
[_tb_end_tyrano_code]
...
[chara_mod  name="Neto"  time="00"  cross="true"  storage="chara/9/1_002.png"  ]
[tb_image_show  time="000"  storage="default/garrafa.png"  width="474"  height="266"  x="319"  y="114"  _clickable_img=""  name="img_31"  ]
[tb_start_text mode=1 ]
...
[tb_image_show  time="000"  storage="default/garrafa.png"  width="1882"  height="1059"  x="-312"  y="-256"  _clickable_img=""  name="img_42"  ]
...
[chara_show  name="Neto"  time="000"  wait="true"  storage="chara/9/1_001.png"  width="709"  height="1029"  left="301"  top="-9"  reflect="false"  ]
[tb_show_message_window  ]
[tb_start_tyrano_code]
#&f.nome
Aqui está sua garrafa, Senhor Neto. Já enchi ela.[p]
[_tb_end_tyrano_code]
